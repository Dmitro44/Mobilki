...
- Работа таймера в фоновом режиме при свёрнутом приложении с отображением уведомлений и возможностью управления из системной панели. Для устройств Xiaomi, Poco и Redmi требуется поддержка уведомлений в стиле #emph("Dynamic Island"), обеспечивающих улучшенную интеграцию в оболочку #emph("HyperOS").
