...
Для обеспечения работы таймера в фоновом режиме реализован сервис, который отображает постоянное уведомление с информацией о текущем состоянии таймера и кнопками управления. Уведомление отображает название выполняемой последовательности, название и оставшееся время текущей фазы, номер текущего повторения, а также визуальный индикатор прогресса выполнения. Кнопки управления позволяют приостановить и возобновить выполнение, остановить таймер, а также перейти к следующей или предыдущей фазе без открытия приложения. На рисунке @notificationScreen представлен интерфейс уведомления сервиса.
